...
const semanaNombre = tp.file.title.trim();
...
const lines = [
    ...
    '  estado AS "Estado"',
    'FROM ""',
    `WHERE tipo = "sesion" AND sesion = "Teoria" AND curso_nombre = "${cursoEsc}" AND ciclo = "${cicloEsc}" AND semana = "${semanaEsc}"`,
    "SORT fecha DESC",
    "```",
    "",
    "---",
    ...
    '  estado AS "Estado"',
    'FROM ""',
    `WHERE tipo = "sesion" AND sesion = "Practica" AND curso_nombre = "${cursoEsc}" AND ciclo = "${cicloEsc}" AND semana = "${semanaEsc}"`,
    "SORT fecha DESC",
    "```",
    "",
    "---",
    ...
    '  estado AS "Estado"',
    'FROM ""',
    `WHERE tipo = "tarea" AND curso_nombre = "${cursoEsc}" AND ciclo = "${cicloEsc}" AND semana = "${semanaEsc}"`,
