...
const tituloTarea = notaNombre.replace(/^Tarea\s*-\s*/i, "").trim() || notaNombre;
...
const tituloEsc = escapeValue(tituloTarea);
...
const lines = [
    ...
    `semana: "${semanaEsc}"`,
    `titulo: "${tituloEsc}"`,
    `fecha_asignacion: ${tp.date.now("YYYY-MM-DD")}`,
    'fecha_entrega: ""',
    'estado: "pendiente"',
    'calificacion: ""',
    'peso: ""',
    ...
    "- [ ] Revise el contenido",
    "- [ ] Adjunte los archivos necesarios",
    "- [ ] Confirme la fecha de entrega",
    "",
    "---",
    "",
    "## Notas",
