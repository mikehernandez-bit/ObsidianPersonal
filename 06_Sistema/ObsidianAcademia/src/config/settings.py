...
class Settings:
    ...
    def _resolve_executable(
        ...
        *,
        ...
        """
        Resuelve una ruta de ejecutable y, si no existe, intenta localizarlo en PATH.
        """
        resolved = self._resolve_path(raw_path, base_dir=base_dir)
        # En sistemas no Windows, priorizar binarios nativos cuando la ruta apunta a .exe.
    ...
    def _load_config(self):
        ...
        self.ffmpeg_exe = self._resolve_executable(
            ffmpeg.get("exe", "tools\\ffmpeg-bin\\ffmpeg.exe"),
            "ffmpeg",
            base_dir=self.config_path.parent,
        )
        self.ffprobe_exe = self._resolve_executable(
        ...
        self.piper_exe = self._resolve_executable(
